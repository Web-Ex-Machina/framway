...
var Hogan = __webpack_require__(61);
Hogan.Template = __webpack_require__(62).Template;
...
var map = {
	...
	"./styling_borders.html": 68,
	"./styling_borders_colors.html": 70,
	"./styling_buttons.html": 72,
	"./styling_buttons_colors.html": 74,
	"./styling_inputs.html": 76,
	"./styling_inputs_bg.html": 78,
	"./styling_inputs_others.html": 80,
	"./styling_inputs_texts.html": 82,
	"./styling_texts.html": 84,
	"./styling_texts_bd.html": 86,
	"./styling_texts_bg.html": 88,
	"./styling_titles.html": 90,
	"./styling_titles_bg.html": 92,
	"./styling_titles_sep.html": 94
};
...
module.exports = {
  ...
  // 'brick',
  'tabs', 'foldingbox', 'block-list', 'block-std', 'block-img', 'block-flip', 'select2FW', 'btn-load', 'accordionFW', 'headerFW', 'guideline']
};
...
Framway.prototype.loadThemes = function (arrThemes) {
  ...
  $.each(arrThemes, function (index, name) {
    try {
      __webpack_require__(111)("./" + name + '/' + name + '.js');
...
global.Component = __webpack_require__(114);
...
var map = {
	...
	"./block-flip/block-flip.js": 33,
	"./block-img/block-img.js": 34,
	"./block-list/block-list.js": 35,
	"./block-std/block-std.js": 36,
	"./brick/brick.js": 37,
	"./btn-load/btn-load.js": 40,
	"./foldingbox/foldingbox.js": 41,
	"./goto/goto.js": 42,
	"./guideline/guideline.js": 43,
	"./headerFW/headerFW.js": 105,
	"./heroFW/heroFW.js": 106,
	"./select2FW/select2FW.js": 107,
	"./sliderFW/sliderFW.js": 109,
	"./tabs/tabs.js": 110
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
...
var BlockFlip = new Component("block-flip");
...
$.fn.Brick = function Brick() {
  var htmlStud = __webpack_require__(38);
  var htmlBrick = __webpack_require__(39);
  $(this).each(function () {
    var $brick = $(this);
    var dim = {
...
if ($('#guideline').length) {
  ...
  var buildComponents = function buildComponents() {
    ...
    $.each(app.components, function (index, component) {
      var sampleText = '';
      try {
        sampleText = __webpack_require__(44)("./" + component + '/sample.html');
      } catch (e) {
  ...
  var buildClasses = function buildClasses() {
    ...
    $.each(arrClasses, function (index, className) {
      ...
      classes.content += '<div class="item active" id="framway__classes-' + className + '">' + '<h2 class="ft-i sep-bottom">' + className.replace(className[0], className[0].toUpperCase()) + '</h2>' + __webpack_require__(63)("./" + className + '.html')() + '</div>';
    });
  ...
  var buildConfig = function buildConfig(obj) {
    ...
    var template = __webpack_require__(96); // noShortcut is used to insert partials later into the final template
    ...
    $.each(obj, function (key, value) {
      if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) != 'object') {
        ...
        rows += __webpack_require__(98)({ str: str });
  ...
  $.each(app.themes, function (index, theme) {
    config = Object.assign(config, __webpack_require__(101)("./" + theme + '/_config.scss'));
  });
...
var map = {
	"./accordionFW/sample.html": 45,
	"./block-flip/sample.html": 46,
	"./block-img/sample.html": 47,
	"./block-list/sample.html": 48,
	"./block-std/sample.html": 49,
	"./brick/sample.html": 50,
	"./btn-load/sample.html": 51,
	"./foldingbox/sample.html": 52,
	"./goto/sample.html": 53,
	"./headerFW/sample.html": 54,
	"./heroFW/sample.html": 56,
	"./select2FW/sample.html": 57,
	"./sliderFW/sample.html": 58,
	"./tabs/sample.html": 59
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
...
HeaderFW.prototype.onCreate = function () {
  ...
  header.$toggler.on('click', function (e) {
    ...
    if (header.$toggler.hasClass('active')) {
      if (header.hasStick) header.$el.addClass('stick');
