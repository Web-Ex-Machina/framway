...
module.exports = {
  ...
  // 'brick',
  'tabs', 'foldingbox', 'block-list', 'block-std', 'block-img', 'select2FW', 'btn-load', 'accordionFW', 'headerFW', 'guideline']
};
...
HeaderFW.prototype.onCreate = function () {
  ...
  var menuEvents = function menuEvents(event) {
    switch (event.type) {
      case 'swipeleft':
