...
var Hogan = __webpack_require__(59);
Hogan.Template = __webpack_require__(60).Template;
...
var map = {
	...
	"./styling_borders.html": 66,
	"./styling_borders_colors.html": 68,
	"./styling_buttons.html": 70,
	"./styling_buttons_colors.html": 72,
	"./styling_inputs.html": 74,
	"./styling_inputs_bg.html": 76,
	"./styling_inputs_others.html": 78,
	"./styling_inputs_texts.html": 80,
	"./styling_texts.html": 82,
	"./styling_texts_bd.html": 84,
	"./styling_texts_bg.html": 86,
	"./styling_titles.html": 88,
	"./styling_titles_bg.html": 90,
	"./styling_titles_sep.html": 92
};
...
Framway.prototype.loadThemes = function (arrThemes) {
  ...
  $.each(arrThemes, function (index, name) {
    try {
      __webpack_require__(109)("./" + name + '/' + name + '.js');
...
global.Component = __webpack_require__(112);
...
var map = {
	...
	"./headerFW/headerFW.js": 103,
	"./heroFW/heroFW.js": 104,
	"./select2FW/select2FW.js": 105,
	"./sliderFW/sliderFW.js": 107,
	"./tabs/tabs.js": 108
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
...
if ($('#guideline').length) {
  ...
  var buildClasses = function buildClasses() {
    ...
    $.each(arrClasses, function (index, className) {
      ...
      classes.content += '<div class="item active" id="framway__classes-' + className + '">' + '<h2 class="ft-i sep-bottom">' + className.replace(className[0], className[0].toUpperCase()) + '</h2>' + __webpack_require__(61)("./" + className + '.html')() + '</div>';
    });
  ...
  var buildConfig = function buildConfig(obj) {
    ...
    var template = __webpack_require__(94); // noShortcut is used to insert partials later into the final template
    ...
    $.each(obj, function (key, value) {
      if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) != 'object') {
        ...
        rows += __webpack_require__(96)({ str: str });
  ...
  $.each(app.themes, function (index, theme) {
    config = Object.assign(config, __webpack_require__(99)("./" + theme + '/_config.scss'));
  });
...
var map = {
	...
	"./goto/sample.html": 51,
	"./headerFW/sample.html": 52,
	"./heroFW/sample.html": 54,
	"./select2FW/sample.html": 55,
	"./sliderFW/sample.html": 56,
	"./tabs/sample.html": 57
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
...
HeaderFW.prototype.onCreate = function () {
  ...
  header.$toggler.on('click', function (e) {
    ...
    if (header.$toggler.hasClass('active')) header.$el.addClass('stick reduced');else {
  ...
  window.addEventListener('scroll', function () {
    header.$el.removeClass('stick');
    if (header.$el.offset().top <= 0 || header.$navPanel.hasClass('active')) header.$el.addClass('stick');else header.$el.removeClass('stick');
    $(window).trigger('resize');
  }, true);
...
HeaderFW.prototype.resizeOnTheFly = function () {
  var header = this;
  var isOffset = false;
  if ((header.$nav.position().left + header.$navInline.children().outerWidth()).toFixed(2) > header.$el.outerWidth() || header.$nav.position().left < 0) isOffset = true;
  if (isOffset) {
    header.$el.addClass('reduced');
    header.menuSwipe.on('swipeleft swiperight', header.menuEvents);
  } else {
    if (!header.$navPanel.hasClass('active')) header.$el.removeClass('reduced');
