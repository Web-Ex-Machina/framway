...
app.loadComponents(['tabs', 'foldingbox', 'guideline']);
...
if ($('#guideline').length) {
  ...
  var buildComponents = function buildComponents() {
    ...
    $.each(app.components, function (index, component) {
      try {
        components.content += '<div class="item row" id="framway__components-' + component + '">' + '<h2 class="ft-i col-12 sep-bottom">' + component + '</h2>' + '<div class="col-12 ">' + __webpack_require__(19)("./" + component + '/sample.html') + '</div>' + '<div class="col-12 ">' + '<pre><code class="language-html"><button class="copy">Copy</button>' + __webpack_require__(21)("./" + component + '/sample.html').replace(/</g, '&lt;').replace(/>/g, '&gt;') + '</code></pre>' + '</div>' + '</div>';
