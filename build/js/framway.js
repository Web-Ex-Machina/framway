...
var map = {
	...
	"./styling_borders.html": 48,
	"./styling_borders_colors.html": 50,
	"./styling_buttons.html": 52,
	"./styling_buttons_colors.html": 54,
	"./styling_inputs.html": 56,
	"./styling_inputs_bg.html": 58,
	"./styling_inputs_others.html": 60,
	"./styling_inputs_texts.html": 62,
	"./styling_texts.html": 64,
	"./styling_texts_bd.html": 66,
	"./styling_texts_bg.html": 68,
	"./styling_titles.html": 70,
	"./styling_titles_bg.html": 72,
	"./styling_titles_sep.html": 74
};
...
global.utils = __webpack_require__(86);
...
if ($('#guideline').length) {
  ...
  var buildClasses = function buildClasses() {
    ...
    $.each(arrClasses, function (index, className) {
      ...
      classes.content += '<div class="item active" id="framway__classes-' + className + '">' + '<h2 class="ft-i sep-bottom">' + className.replace(className[0], className[0].toUpperCase()) + '</h2>' + __webpack_require__(96)("./" + className + '.html')() + '</div>';
    });
  ...
  var buildConfig = function buildConfig(obj) {
    ...
    var template = __webpack_require__(76); // noShortcut is used to insert partials later into the final template
    ...
    $.each(obj, function (key, value) {
      if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) != 'object') {
        ...
        rows += __webpack_require__(78)({ str: str });
...
function Utils() {
  ...
  // NOTIFICATIONS SETUP
  global.toastr = __webpack_require__(87);
