...
var Hogan = __webpack_require__(62);
Hogan.Template = __webpack_require__(63).Template;
...
var map = {
	...
	"./styling_borders.html": 69,
	"./styling_borders_colors.html": 71,
	"./styling_buttons.html": 73,
	"./styling_buttons_colors.html": 75,
	"./styling_inputs.html": 77,
	"./styling_inputs_bg.html": 79,
	"./styling_inputs_others.html": 81,
	"./styling_inputs_texts.html": 83,
	"./styling_texts.html": 85,
	"./styling_texts_bd.html": 87,
	"./styling_texts_bg.html": 89,
	"./styling_titles.html": 91,
	"./styling_titles_bg.html": 93,
	"./styling_titles_sep.html": 95
};
...
Framway.prototype.loadThemes = function (arrThemes) {
  ...
  $.each(arrThemes, function (index, name) {
    try {
      __webpack_require__(113)("./" + name + '/' + name + '.js');
...
global.Component = __webpack_require__(116);
...
var map = {
	...
	"./headerFW/headerFW.js": 106,
	"./heroFW/heroFW.js": 107,
	"./select2FW/select2FW.js": 108,
	"./sliderFW/sliderFW.js": 110,
	"./tabs/tabs.js": 111
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
...
if ($('#guideline').length) {
  ...
  var buildClasses = function buildClasses() {
    ...
    $.each(arrClasses, function (index, className) {
      ...
      classes.content += '<div class="item active" id="framway__classes-' + className + '">' + '<h2 class="ft-i sep-bottom">' + className.replace(className[0], className[0].toUpperCase()) + '</h2>' + __webpack_require__(64)("./" + className + '.html')() + '</div>';
    });
  ...
  var buildConfig = function buildConfig(obj) {
    ...
    var template = __webpack_require__(97); // noShortcut is used to insert partials later into the final template
    ...
    $.each(obj, function (key, value) {
      if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) != 'object') {
        ...
        rows += __webpack_require__(99)({ str: str });
  ...
  $.each(app.themes, function (index, theme) {
    config = Object.assign(config, __webpack_require__(102)("./" + theme + '/_config.scss'));
  });
