...
var Hogan = __webpack_require__(30);
Hogan.Template = __webpack_require__(31).Template;
...
var map = {
	...
	"./styling_borders.html": 34,
	"./styling_borders_colors.html": 36,
	"./styling_buttons.html": 38,
	"./styling_buttons_colors.html": 40,
	"./styling_inputs.html": 42,
	"./styling_inputs_bg.html": 44,
	"./styling_inputs_others.html": 46,
	"./styling_inputs_texts.html": 48,
	"./styling_texts.html": 50,
	"./styling_texts_bd.html": 52,
	"./styling_texts_bg.html": 54,
	"./styling_titles.html": 56,
	"./styling_titles_bg.html": 58,
	"./styling_titles_sep.html": 60
};
...
global.utils = __webpack_require__(71);
...
var map = {
	"./foldingbox/foldingbox.js": 21,
	"./guideline/guideline.js": 22,
	"./tabs/tabs.js": 69
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
    ...
    var setHeight = function setHeight() {
      ...
      if (foldingbox.$el.attr('data-height') && foldingbox.$el.attr('data-height') != "") {
        ...
        foldingbox.content.items.each(function (index, item) {
          ...
          if ($clone.height() > heightBox) heightBox = $clone.height() + parseInt($(item).css('padding')) * 2;
          $clone.remove();
        });
      }
...
if ($('#guideline').length) {
  ...
  var buildComponents = function buildComponents() {
    ...
    $.each(app.components, function (index, component) {
      try {
        components.content += '<div class="item row" id="framway__components-' + component + '">' + '<h2 class="ft-i col-12 sep-bottom">' + component + '</h2>' + '<div class="col-12 ">' + __webpack_require__(23)("./" + component + '/sample.html') + '</div>' + '<div class="col-12 ">' + '<pre><code class="language-html"><button class="copy">Copy</button>' + __webpack_require__(26)("./" + component + '/sample.html').replace(/</g, '&lt;').replace(/>/g, '&gt;') + '</code></pre>' + '</div>' + '</div>';
  ...
  var buildConfig = function buildConfig(obj) {
    ...
    var template = __webpack_require__(62); // noShortcut is used to insert partials later into the final template
    ...
    $.each(obj, function (key, value) {
      if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) != 'object') {
        ...
        rows += __webpack_require__(64)({ str: str });
...
function Utils() {
  ...
  // NOTIFICATIONS SETUP
  global.toastr = __webpack_require__(72);
