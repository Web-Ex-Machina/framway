...
var map = {
	...
	"./styling_borders.html": 55,
	"./styling_borders_colors.html": 57,
	"./styling_buttons.html": 59,
	"./styling_buttons_colors.html": 61,
	"./styling_inputs.html": 63,
	"./styling_inputs_bg.html": 65,
	"./styling_inputs_others.html": 67,
	"./styling_inputs_texts.html": 69,
	"./styling_texts.html": 71,
	"./styling_texts_bd.html": 73,
	"./styling_texts_bg.html": 75,
	"./styling_titles.html": 77,
	"./styling_titles_bg.html": 79,
	"./styling_titles_sep.html": 81
};
...
app.loadComponents(['tabs', 'goto', 'foldingbox', 'block-std', 'sliderFW', 'heroFW', 'block-img', 'guideline']);
console.log(app);
...
if ($('#guideline').length) {
  ...
  var buildClasses = function buildClasses() {
    ...
    $.each(arrClasses, function (index, className) {
      ...
      classes.content += '<div class="item active" id="framway__classes-' + className + '">' + '<h2 class="ft-i sep-bottom">' + className.replace(className[0], className[0].toUpperCase()) + '</h2>' + __webpack_require__(50)("./" + className + '.html')() + '</div>';
    });
  ...
  var buildConfig = function buildConfig(obj) {
    ...
    var template = __webpack_require__(83); // noShortcut is used to insert partials later into the final template
    ...
    $.each(obj, function (key, value) {
      if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) != 'object') {
        ...
        rows += __webpack_require__(85)({ str: str });
