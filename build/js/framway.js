...
var map = {
	...
	"./styling_borders.html": 33,
	"./styling_borders_colors.html": 35,
	"./styling_buttons.html": 37,
	"./styling_buttons_colors.html": 39,
	"./styling_inputs.html": 41,
	"./styling_inputs_bg.html": 43,
	"./styling_inputs_others.html": 45,
	"./styling_inputs_texts.html": 47,
	"./styling_texts.html": 49,
	"./styling_texts_bd.html": 51,
	"./styling_texts_bg.html": 53,
	"./styling_titles.html": 55,
	"./styling_titles_bg.html": 57,
	"./styling_titles_sep.html": 59
};
...
Framway.prototype.loadComponents = function (arrComponents) {
  ...
  $.each(arrComponents, function (index, name) {
    try {
      __webpack_require__(19)("./" + name + '/' + name + '.js');
...
global.utils = __webpack_require__(70);
...
var map = {
	"./foldingbox/foldingbox.js": 20,
	"./guideline/guideline.js": 21,
	"./tabs/tabs.js": 68
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
...
if ($('#guideline').length) {
  ...
  var buildComponents = function buildComponents() {
    ...
    $.each(app.components, function (index, component) {
      try {
        components.content += '<div class="item row" id="framway__components-' + component + '">' + '<h2 class="ft-i col-12 sep-bottom">' + component + '</h2>' + '<div class="col-12 ">' + __webpack_require__(22)("./" + component + '/sample.html') + '</div>' + '<div class="col-12 ">' + '<pre><code class="language-html"><button class="copy">Copy</button>' + __webpack_require__(25)("./" + component + '/sample.html').replace(/</g, '&lt;').replace(/>/g, '&gt;') + '</code></pre>' + '</div>' + '</div>';
  ...
  var buildConfig = function buildConfig(obj) {
    ...
    var template = __webpack_require__(61); // noShortcut is used to insert partials later into the final template
    ...
    $.each(obj, function (key, value) {
      if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) != 'object') {
        ...
        rows += __webpack_require__(63)({ str: str });
