...
var Hogan = __webpack_require__(51);
Hogan.Template = __webpack_require__(52).Template;
...
var Utils = function Utils() {
  ...
  // NOTIFICATIONS SETUP
  global.toastr = __webpack_require__(28);
...
var map = {
	...
	"./styling_borders.html": 58,
	"./styling_borders_colors.html": 60,
	"./styling_buttons.html": 62,
	"./styling_buttons_colors.html": 64,
	"./styling_inputs.html": 66,
	"./styling_inputs_bg.html": 68,
	"./styling_inputs_others.html": 70,
	"./styling_inputs_texts.html": 72,
	"./styling_texts.html": 74,
	"./styling_texts_bd.html": 76,
	"./styling_texts_bg.html": 78,
	"./styling_titles.html": 80,
	"./styling_titles_bg.html": 82,
	"./styling_titles_sep.html": 84
};
...
module.exports = {
  ...
  // 'brick',
  'tabs', 'foldingbox', 'block-list', 'block-std', 'block-img', 'guideline']
};
...
Framway.prototype.loadComponents = function (arrComponents) {
  ...
  $.each(arrComponents, function (index, name) {
    try {
      __webpack_require__(30)("./" + name + '/' + name + '.js');
...
var map = {
	"./block-img/block-img.js": 31,
	"./block-list/block-list.js": 32,
	"./block-std/block-std.js": 33,
	"./brick/brick.js": 34,
...
$.fn.Brick = function Brick() {
  var htmlStud = __webpack_require__(35);
  var htmlBrick = __webpack_require__(36);
  $(this).each(function () {
    var $brick = $(this);
    var dim = {
...
if ($('#guideline').length) {
  ...
  var buildComponents = function buildComponents() {
    ...
    $.each(app.components, function (index, component) {
      var sampleText = '';
      try {
        sampleText = __webpack_require__(40)("./" + component + '/sample.html');
      } catch (e) {
  ...
  var buildClasses = function buildClasses() {
    ...
    $.each(arrClasses, function (index, className) {
      ...
      classes.content += '<div class="item active" id="framway__classes-' + className + '">' + '<h2 class="ft-i sep-bottom">' + className.replace(className[0], className[0].toUpperCase()) + '</h2>' + __webpack_require__(53)("./" + className + '.html')() + '</div>';
    });
  ...
  var buildConfig = function buildConfig(obj) {
    ...
    var template = __webpack_require__(86); // noShortcut is used to insert partials later into the final template
    ...
    $.each(obj, function (key, value) {
      if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) != 'object') {
        ...
        rows += __webpack_require__(88)({ str: str });
...
var map = {
	"./block-img/sample.html": 41,
	"./block-list/sample.html": 42,
	"./block-std/sample.html": 43,
	"./brick/sample.html": 44,
	"./foldingbox/sample.html": 45,
	"./goto/sample.html": 46,
	"./heroFW/sample.html": 47,
	"./sliderFW/sample.html": 48,
	"./tabs/sample.html": 49
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
