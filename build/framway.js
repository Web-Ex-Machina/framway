...
global.utils = __webpack_require__(64);
...
if ($('#guideline').length) {
  ...
  var buildStyling = function buildStyling() {
    ...
    if (config['enable-bg'] == 'true') {
      ...
      $.each(config.colors, function (key, value) {
        styling.content += __webpack_require__(4)({ color: key });
      });
      styling.content += '</div>';
    }
    // BORDERS
  ...
  var buildTabs = function buildTabs(tabsConfig) {
    ...
    $.each(tabsConfig, function (title, templateName) {
      ...
      if (title.toLowerCase() != "bordered" && title.toLowerCase() != "backgrounded" && title.toLowerCase() != "colored") content += __webpack_require__(5)("./styling_" + templateName + '.html')();else {
        content += '<div class="tab">';
        $.each(config.colors, function (key, value) {
          content += __webpack_require__(5)("./styling_" + templateName + '.html')({ color: key });
        });
        content += '</div>';
      }
    });
