...
var map = {
	...
	"./styling_borders.html": 37,
	"./styling_borders_colors.html": 39,
	"./styling_buttons.html": 41,
	"./styling_buttons_colors.html": 43,
	"./styling_inputs.html": 45,
	"./styling_inputs_bg.html": 47,
	"./styling_inputs_others.html": 49,
	"./styling_inputs_texts.html": 51,
	"./styling_texts.html": 53,
	"./styling_texts_bd.html": 55,
	"./styling_texts_bg.html": 57,
	"./styling_titles.html": 59,
	"./styling_titles_bg.html": 61,
	"./styling_titles_sep.html": 63
};
...
app.loadComponents(['tabs', 'foldingbox', 'block-std', 'guideline']);
...
global.utils = __webpack_require__(74);
    ...
    var setHeight = function setHeight() {
      ...
      if (foldingbox.$el.attr('data-height') && foldingbox.$el.attr('data-height') != "") {
        ...
        foldingbox.content.items.each(function (index, item) {
          ...
          if ($clone.height() > heightBox) heightBox = $clone.height() + parseInt($(item).css('padding-top')) * 2;
          $clone.remove();
        });
      }
...
if ($('#guideline').length) {
  ...
  var buildComponents = function buildComponents() {
    ...
    $.each(app.components, function (index, component) {
      try {
        components.content += '<div class="item row" id="framway__components-' + component + '">' + '<h2 class="ft-i col-12 sep-bottom">' + component + '</h2>' + '<div class="col-12 ">' + __webpack_require__(24)("./" + component + '/sample.html') + '</div>' + '<div class="col-12 ">' + '<pre><code class="language-html"><button class="copy">Copy</button>' + __webpack_require__(28)("./" + component + '/sample.html').replace(/</g, '&lt;').replace(/>/g, '&gt;') + '</code></pre>' + '</div>' + '</div>';
  ...
  var buildConfig = function buildConfig(obj) {
    ...
    var template = __webpack_require__(65); // noShortcut is used to insert partials later into the final template
    ...
    $.each(obj, function (key, value) {
      if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) != 'object') {
        ...
        rows += __webpack_require__(67)({ str: str });
...
var map = {
	"./block-std/sample.html": 29,
	"./foldingbox/sample.html": 30,
	"./tabs/sample.html": 31
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
...
function Utils() {
  ...
  // NOTIFICATIONS SETUP
  global.toastr = __webpack_require__(75);
