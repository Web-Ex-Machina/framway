...
var map = {
	...
	"./styling_borders.html": 35,
	"./styling_borders_colors.html": 37,
	"./styling_buttons.html": 39,
	"./styling_buttons_colors.html": 41,
	"./styling_inputs.html": 43,
	"./styling_inputs_bg.html": 45,
	"./styling_inputs_others.html": 47,
	"./styling_inputs_texts.html": 49,
	"./styling_texts.html": 51,
	"./styling_texts_bd.html": 53,
	"./styling_texts_bg.html": 55,
	"./styling_titles.html": 57,
	"./styling_titles_bg.html": 59,
	"./styling_titles_sep.html": 61
};
...
Framway.prototype.loadComponents = function (arrComponents) {
  ...
  $.each(arrComponents, function (index, name) {
    try {
      __webpack_require__(21)("./" + name + '/' + name + '.js');
...
global.utils = __webpack_require__(72);
...
var map = {
	"./foldingbox/foldingbox.js": 22,
	"./guideline/guideline.js": 23,
	"./tabs/tabs.js": 70
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
...
if ($('#guideline').length) {
  ...
  var buildComponents = function buildComponents() {
    ...
    $.each(app.components, function (index, component) {
      try {
        components.content += '<div class="item row" id="framway__components-' + component + '">' + '<h2 class="ft-i col-12 sep-bottom">' + component + '</h2>' + '<div class="col-12 ">' + __webpack_require__(24)("./" + component + '/sample.html') + '</div>' + '<div class="col-12 ">' + '<pre><code class="language-html"><button class="copy">Copy</button>' + __webpack_require__(27)("./" + component + '/sample.html').replace(/</g, '&lt;').replace(/>/g, '&gt;') + '</code></pre>' + '</div>' + '</div>';
  ...
  var buildConfig = function buildConfig(obj) {
    ...
    var template = __webpack_require__(63); // noShortcut is used to insert partials later into the final template
    ...
    $.each(obj, function (key, value) {
      if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) != 'object') {
        ...
        rows += __webpack_require__(65)({ str: str });
...
function Utils() {
  ...
  // NOTIFICATIONS SETUP
  global.notif = __webpack_require__(16);
